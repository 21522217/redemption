...
const PostDropdown = ({ post }: { post: Post }) => (
  <DropdownMenu>
    ...
    >
      <DropdownMenuItem className="flex justify-between w-full px-4 py-2.5 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 cursor-pointer transition-colors">
